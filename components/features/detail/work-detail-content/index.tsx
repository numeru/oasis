...
type Props = {
	workDetailData: WorkDetailInfo;
	showDeleteModal: boolean;
	handleClickCancelButton: () => void;
};

const WorkDetailContent = ({ workDetailData, showDeleteModal, handleClickCancelButton }: Props) => {
	const [isMine, cclInstruction] = useGetWorkDetail(workDetailData);
